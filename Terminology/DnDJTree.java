...
public class DnDJTree extends JPanel {
	...
	public DnDJTree(JSONObject term_graph, String domain, JSONArray term_no_path, Terminology_interface frame) {
		...
		second_tree.setTransferHandler(new TransferHandler() {
			...
			public boolean importData(TransferSupport support) {
				...
				// Function to find node that user wants to delete
				...
				// Update other graph to display term at the correct position
		...
		tree.addMouseListener(new MouseAdapter() {
			...
			// If the user right clicks a term  delete it from the domain
		...
		second_tree.addMouseListener(new MouseAdapter() {
			...
			// If the user right clicks a term move it from used term column to unused term column
	...
	// Creates the TreeModel for unused terms in the selected domain
	...
	// Creates the TreeModel for used terms in the selected domain
	...
	// Recurrent function to find node to delete
	...
	// Recurrent function to find new path for node
	private boolean rec_find_new_node_path(MutableTreeNode curr_node, String to_be_found, JSONObject curr_path,
			int curr_depth) {
		int child_count = curr_node.getChildCount();
		boolean found = false;
